                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        <FormControl>
                            ...
                            <FormLabel mt={5} display={'flex'}>Performance Fee % <UserInfo info="This is the % the fund manager earns for the profits earned, relative to main fund asset (BASE, USD or COT)." /></FormLabel>
                            <InputGroup width="100%">
